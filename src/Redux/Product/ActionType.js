...
export const FIND_PRODUCT_BY_CATEGORY_REQUEST = "GET_PRODUCT_REQUEST";
export const FIND_PRODUCT_BY_CATEGORY_SUCCESS = "GET_PRODUCT_SUCCESS";
export const FIND_PRODUCT_BY_CATEGORY_FAILURE = "GET_PRODUCT_FAILURE";